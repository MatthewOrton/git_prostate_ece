...
patFolders = dir('/Volumes/BigBackup/PROSTATE_DIR/anon/DevelopmentData/IAP*');

% select patients 074, 100, 235
patFolders = patFolders([57 76 158]);
        ...
        for iStudy = 0:jStudyList.size-1
            ...
            for iSer = 0:jSeriesList.size-1
                ...
                for iInst = 0:jInstList.size-1
                    ...
                    sessionInfo = [char(jInst.getStudyDate) '_' num2str(round(str2double(jInst.getStudyTime)))];
                    ...
                    destinFolder = strrep(sourceFolder,'DevelopmentData','DevelopmentDataCorrected');
